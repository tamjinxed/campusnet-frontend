        ...
        <div className="hidden lg:flex lg:w-1/2 bg-campus-gradient relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative">
                ...
                <div className="w-72 h-72 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center">
                  <div className="w-48 h-48 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center">
                    <div className="text-center text-white">
                      <h2 className="text-4xl font-bold mb-4 animate-pulse-gentle">CampusNet</h2>
                      <p className="text-xl opacity-90">Connect. Learn. Grow.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Orbiting Elements */}
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-8 w-16 h-16 bg-white/20 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
              <div className="absolute bottom-0 right-0 transform translate-x-8 translate-y-8 w-12 h-12 bg-white/20 rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
              <div className="absolute top-1/2 left-0 transform -translate-x-8 -translate-y-1/2 w-20 h-20 bg-white/20 rounded-full animate-float" style={{ animationDelay: '0.5s' }}></div>
            </div>
          </div>

          {/* Text Content */}
          <div className="absolute bottom-20 left-20 right-20 text-white z-10">
            <h1 className="text-5xl font-bold mb-6 animate-fade-in">Welcome Back</h1>
            <p className="text-xl opacity-90 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              Connect with your campus community and discover endless opportunities for learning and growth.
            </p>
          </div>
        </div>
